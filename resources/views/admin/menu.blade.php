<aside class="main-sidebar">
    ...
    <section class="sidebar">
        <ul class="sidebar-menu">
            ...
            <li><a href="backend/news?type=hinh-anh"><i class="fa fa-circle-o"></i> <span>Hình ảnh</span></a></li>
            <li><a href="backend/video"><i class="fa fa-circle-o"></i> <span>Video</span></a></li>
             <!-- <li><a href="backend/lienket?type=hinh-anh"><i class="fa fa-gear" aria-hidden="true"></i> <span>Hình ảnh</span></a></li> -->
